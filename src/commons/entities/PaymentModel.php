...
class PaymentModel
{
    ...
    public array $payload; // JSON decodificado

    public function __construct(string $id_payment , string $event_id, string $customer_id, string $payment_intent_id, StripeEventTypeEnum $eventType, array $payload) {
