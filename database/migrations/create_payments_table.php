...
return function(PDO $pdo) {
    $sql = <<<SQL
                CREATE TABLE payments ( id_payment VARCHAR(50) PRIMARY KEY, event_id VARCHAR(50) NOT NULL,
 customer_id VARCHAR(50) NOT NULL, payment_intent_id VARCHAR(50) NOT NULL, event_type VARCHAR(50) NOT NULL,
